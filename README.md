...
> Motorola Mobile Sales Data across India
...
| 🗺️ Map | Total Sales by City (18 Cities) |
...
|--------|-------|---|
| UPI | 215 | 26.25% |
| Debit Card | 212 | 25.89% |
| Cash | 205 | 25.03% |
| Credit Card | 187 | 22.83% |

## 📱 Mobile Model Performance

| Model | Total Sales | Quantity |
|-------|-------------|---------|
| Galaxy Note 20 | 56,005,282 | 1,382 |
| Galaxy S21 | 53,270,714 | 1,305 |
| iPhone 11 | 51,520,221 | 1,263 |
| Galaxy A51 | 50,762,059 | 1,236 |

## 🎥 Dashboard Demo

[![Dashboard Demo](./Overview-dashboard.png)](https://youtu.be/iJ1fXeDSKXY?si=5xlCxOMm5Uso0pyj)
